...
Requires a live Postgres reachable via TEST_DATABASE_URL with migrations 0001
and (once it exists) 0002 applied. Skipped otherwise — this is a real
integration test against RLS, not something a unit-test mock can substitute for.
"""
